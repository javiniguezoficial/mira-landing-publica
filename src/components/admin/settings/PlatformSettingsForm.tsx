...
export function PlatformSettingsForm({ defaultValues }: Props) {
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <div>
        <label htmlFor="platform_name" className={fieldLabel}>
      ...
      {/* Email de soporte */}
      <div>
        <label htmlFor="support_email" className={fieldLabel}>
          Email de soporte
        </label>
        <input
          id="support_email"
      ...
      {/* País por defecto */}
      <div>
        <label htmlFor="default_country" className={fieldLabel}>
      ...
      {/* Moneda por defecto */}
      <div>
        <label htmlFor="default_currency" className={fieldLabel}>
      ...
      {/* Modo mantenimiento */}
      <div>
        <p className="mb-2 block text-sm font-bold text-mira-ink">Modo mantenimiento</p>
