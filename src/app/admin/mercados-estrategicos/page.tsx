...
import { Plus, Pencil, Globe2 } from 'lucide-react'
import { getStrategicMarkets, toggleStrategicMarket } from '@/lib/actions/markets'
                  ...
                  <tr key={sm.id} className="transition-colors hover:bg-mira-canvas/70">
                    <td className="px-5 py-3 font-bold text-mira-ink sm:px-6">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p>{sm.name}</p>
                          {sm.description && <p className="text-xs font-normal text-slate-400">{sm.description}</p>}
                        </div>
                      </div>
                    </td>
