      ...
      <div className="mira-card rounded-2xl p-6">
        ...
        <div className="space-y-1.5 rounded-xl bg-mira-canvas/60 p-4">
          ...
          {[
            ...
            '«mercado», «categoria», «familia» y «subfamilia» se resuelven contra la taxonomía propia de proveedores (no es la de Pricing), en cascada: la categoría debe existir dentro del mercado, la familia dentro de la categoría, etc.',
            'Si un nivel de taxonomía no existe, se avisa y ese nivel (y los inferiores) quedan sin clasificar. No se crea taxonomía automáticamente: créala antes en «Gestionar taxonomía».',
